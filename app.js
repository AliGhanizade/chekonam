...
function setMode(mode){
  ...
  if(cards) renderMysteryCards(); if(auto) $('#autoStage strong').textContent='در حال پیدا کردن...'; if(scratch) renderScratchGrid(); if(box) resetBox();
}
function runMode(){ if(state.mode==='cards') return renderMysteryCards(); if(state.mode==='auto') return autoPick(); if(state.mode==='scratch') return renderScratchGrid(); return openBox(true); }
